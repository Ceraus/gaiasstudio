...
const RECT_ROWS = [
  ...
  ['8162', 0.833, 0.833, 0.156, 0.156, 7, 2, 0.188, 0, 'Shipping (inkjet)'],
  ['5352', 0.5, 0.5, 0.1875, 0.1875, 10, 3, 0.125, 0, 'File folder'],
  ['5165', 0.5, 0.5, 0.375, 0.375, 15, 4, 0.25, 0, 'Return address'],
  ['8460', 0.5, 0.5, 0.25, 0.25, 10, 2, 0, 0, 'Binder / spine'],
  ['8461', 0.833, 0.833, 0.3125, 0.3125, 7, 2, 0.125, 0, 'Binder / spine'],
  ['18163', 0.833, 0.833, 0.156, 0.156, 7, 2, 0.188, 0, 'Presta shipping'],
];
...
const SHAPE_SPECS = [
  ...
  ['round-1-5', 'Round 1.5"', 'circle', 1.5, 1.5, 4, 5, 0.25, 0.25, '8293'],
  ['round-1-67-avery', 'Round 1-2/3" (5293)', 'circle', 1.667, 1.667, 4, 6, 0.15, 0.12, '5293'],
  ...
  ['oval-2-5x1', 'Oval 2.5" x 1"', 'oval', 2.5, 1, 3, 8, 0.2, 0.2, '5395'],
